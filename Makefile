...
.PHONY: clean pyclean test lint isort docker setup.py check_forgotten_migrations_venv check_forgotten_migrations
...
test/docker: docker/check_forgotten_migrations docker/tox
	@echo 'tests done'

test: check_forgotten_migrations_venv tox_venv
	@echo 'tests done'
